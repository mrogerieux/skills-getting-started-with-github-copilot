  ...
  async function fetchActivities() {
    try {
      ...
      Object.entries(activities).forEach(([name, details]) => {
        ...
        participantWrapper.appendChild(participantList);
        ...
        activityCard.appendChild(participantWrapper);
